...
1. **Edit Julia code**: Modify `src/MyLib.jl`
2. **Rebuild**: Run `julia compile.jl` (fast incremental build)
3. **Recompile C++**: Run `./package_library.sh` if you modified `micro_iters.cpp`
4. **Test**: Run your example/test application
...
[Add contact information or project repository URL here]
